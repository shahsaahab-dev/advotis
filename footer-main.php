...
<section class="conversion_area pad_top">
	<div class="container">
		<div class="center_title">
			...
			<p>Collaboratively administrate empowered markets via plug-and-play networks. Dynamically procra-stinate B2C
				users after installed base benefits. Dramatically visualize customer directed conver-gence without
				revolutionary ROI.</p>
		</div>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="conversion_text">
						...
						<div class="nice-select" tabindex="0"><span class="current">Select an industry</span>
							<ul class="list">
								<li data-value="1" class="option selected">Select an industry</li>
								<li data-value="2" class="option">Another option</li>
								<li data-value="3" class="option">Potato</li>
							</ul>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="conversion_subs">
						<p>We help global leaders with their organization's most critical issues and opportunities.
							Together, we create enduring change and results.</p>
